...
doc_events = {
    "Purchase Receipt": {
        "on_submit": "purchase_enhancements.reminder_service.ReminderManager.update_reminders_for_receipt"
    },
    "Purchase Invoice": {
        "on_submit": "purchase_enhancements.reminder_service.ReminderManager.update_reminders_for_receipt"
    },
    "Purchase Order": {
        "on_cancel": "purchase_enhancements.reminder_service.ReminderManager.handle_po_cancellation",
        "on_submit": "purchase_enhancements.reminder_service.ReminderManager.clear_item_history_cache"
    }
}

scheduler_events = {
    "daily": [
        "purchase_enhancements.reminder_service.ReminderManager.escalate_overdue_reminders",
        "purchase_enhancements.reminder_service.ReminderManager.send_daily_reminder_digest"
    ],
    "weekly": [
        "purchase_enhancements.reminder_service.ReminderManager.cleanup_closed_reminders"
    ]
}
